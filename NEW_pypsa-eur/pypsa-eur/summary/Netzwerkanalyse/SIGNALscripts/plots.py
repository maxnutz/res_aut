from SIGNALscripts.utils import *
from SIGNALscripts.notebooks import *
...
def plot_HDW(df,
    ...
    df[var].plot(ax=ax, color=colors[0], marker='.', alpha=0.8, linestyle='None', legend=False)
    ax.set_xlabel(xlabel)###alpha 0.3 is vl einfach bisschen wenig
